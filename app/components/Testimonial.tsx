    ...
    <div className="relative max-w-[85rem] px-4 py-8 sm:px-6 lg:px-8 lg:py-10 mx-auto">
      <blockquote className="text-center lg:mx-auto lg:w-4/5">
        ...
        <p className="text-lg leading-normal max-w-[90%] mx-auto">
          PlanzIt has transformed my scheduling! Its user-friendly interface and
          seamless Google Cloud integration make organizing appointments a
          breeze. The real-time collaboration features are a game changer.
          Highly recommended for anyone looking to streamline their schedule!
        </p>
